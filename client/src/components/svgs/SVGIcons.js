...
export const data = [
	{
		...
		description: "HTML",
		notes: "Learned HTML during undergrad years to build small static websites",
	},
	{
		id: 2,
		icon: <CSSIcon size={size} />,
		description: "CSS",
		notes: "Learned CSS during undergrad years to build small static websites",
	},
	{
		id: 3,
		...
		notes:
			"Learned Javascript during undergrad years and continue to use it today to create interactive SVG elements.",
	},
	{
		id: 4,
		...
		description: "Python",
		notes:
			"Learned Python during undergrad years to build small static websites. Used in with Django to configure server backends",
	},
	{
		id: 5,
		...
		description: "Nodejs",
		notes:
			"Used various libraries related to frontend testing, SVG manipulation, and image manipulation",
	},
	{
		id: 6,
		...
		description: "React",
		notes:
			" Created many interactive websites with React, including but not limited to, an online shopping platform and employment database management system",
	},
	{
		id: 7,
		icon: <GithubIcon size={size} />,
		description: "Github",
		notes: "Using Github to store personal projects.",
	},
	{
		id: 8,
	...
	},
	{
		...
		description: "Sass",
		notes:
			"Experienced with Sass/SCSS' nesting structure and mixins. Used with the Angular Framework.",
	},
	{
		id: 10,
		...
		notes:
			"Using it as a quick and easy way of prototyping websites with its quick styling methods",
	},
	{
		id: 11,
		...
		description: "Express",
		notes:
			"Use Express to create servers connecting to mySQL and MongoDB and interacting with the client-side",
	},
	{
		id: 12,
		icon: <GatsbyIcon size={size} />,
		description: "Gatsby",
		notes: "Used Gatsby to create a basic website",
	},
	{
		id: 13,
	...
	},
	{
		...
		description: "MUI",
		notes:
			"A quick and easy way of prototyping responsive components. Have customized them with Theme providers as well",
	},
	// {
	//     id: 17,
